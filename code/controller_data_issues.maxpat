...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 282.0, 118.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 98.0, 153.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 219.5, 523.0, 196.0, 22.0 ],
					"style" : "",
					"text" : "map.out dummy i @min 0 @max 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 676.0, 276.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 676.0, 305.0, 668.0, 76.0 ],
					"style" : "",
					"text" : "soundman_carrier soundman_ratio soundman_depth soundman_rate_1 soundman_rate_2 soundman_whuteva soundman_feedback soundman_rate soundman_centre soundman_bw sinc sin sinc1 sin1 master_clock_1 master_clock_2 master_clock_3 down up hi lo soundman_damping soundman_rotate soundman_fluctuate soundman_decay gran_freq min gran_freq max gran_density min gran_density_max buffer_head_min buffer_head max gran_speed_min gran_speed_max gran_sample gran_ahead_min gran_ahead_max"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 355.0, 380.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "* 100"
								}
